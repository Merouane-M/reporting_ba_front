    ...
    <div className="bg-white flex justify-center rounded-lg shadow p-6 w-full">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-gray-500">
          Sélectionnez un mois. La date sera automatiquement fixée au dernier jour du mois.
        </p>
        <input
          type="month"
          className="border border-gray-300 rounded-md p-3 w-64 focus:outline-none focus:ring-2 focus:ring-sofiblue focus:border-sofiblue transition duration-200"
